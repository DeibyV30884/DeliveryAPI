...
import { obtenerPerfilAdministrador, editarPerfilAdministrador, desactivarPerfilAdministrador } from '../../api/usuarios'
...
function PerfilAdministrador() {
    ...
    async function handleGuardar() {
        ...
        try {
            await editarPerfilAdministrador(payload)
            setExito('Perfil actualizado correctamente')

            const res = await obtenerPerfilAdministrador()
            const d = res.data
            setFormData(function (prev) {
    ...
    async function handleEliminar() {
        ...
        try {
            await desactivarPerfilAdministrador()
            cerrarSesion()
        } catch (err) {
